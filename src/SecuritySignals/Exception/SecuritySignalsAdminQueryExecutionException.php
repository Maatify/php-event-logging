...
class SecuritySignalsAdminQueryExecutionException extends SystemMaatifyException implements EventLoggingExceptionInterface
{
    public static function executionFailed(Throwable $previous): self
    {
        return new self(
            message: 'SecuritySignals Admin Query execution failed: ' . $previous->getMessage(),
            previous: $previous,
        );
    }
